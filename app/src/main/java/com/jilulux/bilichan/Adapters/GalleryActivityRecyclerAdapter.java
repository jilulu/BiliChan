...
import com.jilulux.bilichan.Helpers.KonaObject;
import com.jilulux.bilichan.Helpers.UserFavObject;
import com.jilulux.bilichan.PhotoActivity;
...
public class GalleryActivityRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final String EXTRA = com.jilulux.bilichan.Adapters.GalleryActivityRecyclerAdapter.class.getName();
