 ...
 */
public class MuseMemberProfiles {
    private String jaName, romaji, hiragana, basics, mangaText, animeText, konaID;
    private int resID;

    public MuseMemberProfiles(String ja) {
        jaName = ja;
        init();
    }
